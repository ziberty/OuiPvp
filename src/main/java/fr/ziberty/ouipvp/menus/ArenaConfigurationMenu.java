...
public class ArenaConfigurationMenu {

    public static Inventory menu;

    public ArenaConfigurationMenu() {
        buildMenu(Bukkit.createInventory(null, 27, "Configuration des arènes"));
    }
    ...
    private void buildMenu(Inventory menu) {
        ...
        ArenaConfigurationMenu.menu = menu;
    }
